<div>
    ...
    <!-- Modal -->
    @if($showModal)
        <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="modal-content relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Apply Form</h3>
                        <form class="space-y-6" wire:submit.prevent="submit">
                            ...
                            <div>
                                <label for="experience" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Experience (years)</label>
                            ...
                            <div>
                                <label for="infoSource" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Information Source</label>
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        ...
                                        <label for="infoSource1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Internet</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="infoSource2" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Friends</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="infoSource3" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Advertising</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="infoSource4" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Other</label>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <label for="interestReason" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reason for Interest</label>
                            ...
                            <div>
                                <label for="hindrance" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Hindrance</label>
